#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-MP-A4T8-01
library(dpclust3p)

sample <- "TCGA-MP-A4T8-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_luad\TCGA-MP-A4T8-01"
