#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-MN-A4N1-01
library(dpclust3p)

sample <- "TCGA-MN-A4N1-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_luad\TCGA-MN-A4N1-01"
