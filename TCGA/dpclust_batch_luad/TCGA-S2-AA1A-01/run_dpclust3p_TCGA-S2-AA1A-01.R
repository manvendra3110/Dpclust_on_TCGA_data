#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-S2-AA1A-01
library(dpclust3p)

sample <- "TCGA-S2-AA1A-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_luad\TCGA-S2-AA1A-01"
