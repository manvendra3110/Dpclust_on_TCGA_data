#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-J2-8192-01
library(dpclust3p)

sample <- "TCGA-J2-8192-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_luad\TCGA-J2-8192-01"
