#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-55-8510-01
library(dpclust3p)

sample <- "TCGA-55-8510-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_luad\TCGA-55-8510-01"
