#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-L9-A444-01
library(dpclust3p)

sample <- "TCGA-L9-A444-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_luad\TCGA-L9-A444-01"
