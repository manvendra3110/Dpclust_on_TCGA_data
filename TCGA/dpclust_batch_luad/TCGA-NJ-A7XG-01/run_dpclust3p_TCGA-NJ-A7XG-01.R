#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-NJ-A7XG-01
library(dpclust3p)

sample <- "TCGA-NJ-A7XG-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_luad\TCGA-NJ-A7XG-01"
