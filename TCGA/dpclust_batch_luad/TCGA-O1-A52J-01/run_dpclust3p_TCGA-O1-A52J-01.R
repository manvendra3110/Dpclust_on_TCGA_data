#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-O1-A52J-01
library(dpclust3p)

sample <- "TCGA-O1-A52J-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_luad\TCGA-O1-A52J-01"
