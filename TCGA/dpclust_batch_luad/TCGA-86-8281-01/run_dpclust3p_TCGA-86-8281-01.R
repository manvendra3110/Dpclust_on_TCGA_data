#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-86-8281-01
library(dpclust3p)

sample <- "TCGA-86-8281-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_luad\TCGA-86-8281-01"
