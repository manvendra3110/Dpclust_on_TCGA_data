#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-BA-5149-01
library(dpclust3p)

sample <- "TCGA-BA-5149-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-BA-5149-01"
