#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-Z2-AA3S-06
library(dpclust3p)

sample <- "TCGA-Z2-AA3S-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-Z2-AA3S-06"
