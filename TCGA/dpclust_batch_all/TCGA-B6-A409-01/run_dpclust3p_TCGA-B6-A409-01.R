#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-B6-A409-01
library(dpclust3p)

sample <- "TCGA-B6-A409-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-B6-A409-01"
