#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-OX-A56R-01
library(dpclust3p)

sample <- "TCGA-OX-A56R-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-OX-A56R-01"
