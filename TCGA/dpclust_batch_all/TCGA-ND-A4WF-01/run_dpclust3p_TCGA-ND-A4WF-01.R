#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-ND-A4WF-01
library(dpclust3p)

sample <- "TCGA-ND-A4WF-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-ND-A4WF-01"
