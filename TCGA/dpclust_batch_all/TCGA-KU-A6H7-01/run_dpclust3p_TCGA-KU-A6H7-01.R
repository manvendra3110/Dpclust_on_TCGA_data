#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-KU-A6H7-01
library(dpclust3p)

sample <- "TCGA-KU-A6H7-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-KU-A6H7-01"
