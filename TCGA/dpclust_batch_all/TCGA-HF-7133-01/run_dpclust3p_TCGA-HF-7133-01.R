#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-HF-7133-01
library(dpclust3p)

sample <- "TCGA-HF-7133-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-HF-7133-01"
