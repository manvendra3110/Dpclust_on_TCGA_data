#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-MM-A84U-01
library(dpclust3p)

sample <- "TCGA-MM-A84U-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-MM-A84U-01"
