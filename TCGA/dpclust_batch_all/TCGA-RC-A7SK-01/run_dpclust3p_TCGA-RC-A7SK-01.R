#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-RC-A7SK-01
library(dpclust3p)

sample <- "TCGA-RC-A7SK-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-RC-A7SK-01"
