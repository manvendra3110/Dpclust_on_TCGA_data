#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-ZG-A9ND-01
library(dpclust3p)

sample <- "TCGA-ZG-A9ND-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-ZG-A9ND-01"
