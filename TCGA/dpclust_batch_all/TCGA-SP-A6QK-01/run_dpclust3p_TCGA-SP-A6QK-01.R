#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-SP-A6QK-01
library(dpclust3p)

sample <- "TCGA-SP-A6QK-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-SP-A6QK-01"
