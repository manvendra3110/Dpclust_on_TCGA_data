#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-MU-A8JM-01
library(dpclust3p)

sample <- "TCGA-MU-A8JM-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-MU-A8JM-01"
