#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-WJ-A86L-01
library(dpclust3p)

sample <- "TCGA-WJ-A86L-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-WJ-A86L-01"
