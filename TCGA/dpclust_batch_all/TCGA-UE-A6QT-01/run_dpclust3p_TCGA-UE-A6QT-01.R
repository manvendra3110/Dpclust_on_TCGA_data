#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-UE-A6QT-01
library(dpclust3p)

sample <- "TCGA-UE-A6QT-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-UE-A6QT-01"
