#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-JX-A3PZ-01
library(dpclust3p)

sample <- "TCGA-JX-A3PZ-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-JX-A3PZ-01"
