#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-G5-6641-01
library(dpclust3p)

sample <- "TCGA-G5-6641-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-G5-6641-01"
