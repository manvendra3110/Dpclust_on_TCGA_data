#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-KO-8411-01
library(dpclust3p)

sample <- "TCGA-KO-8411-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-KO-8411-01"
