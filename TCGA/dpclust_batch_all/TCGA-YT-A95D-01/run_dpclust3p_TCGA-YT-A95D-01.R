#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-YT-A95D-01
library(dpclust3p)

sample <- "TCGA-YT-A95D-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-YT-A95D-01"
