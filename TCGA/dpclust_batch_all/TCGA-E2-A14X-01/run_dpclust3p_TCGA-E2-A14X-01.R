#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-E2-A14X-01
library(dpclust3p)

sample <- "TCGA-E2-A14X-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-E2-A14X-01"
