#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-HG-A9SC-01
library(dpclust3p)

sample <- "TCGA-HG-A9SC-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-HG-A9SC-01"
