#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IQ-A61I-01
library(dpclust3p)

sample <- "TCGA-IQ-A61I-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IQ-A61I-01"
