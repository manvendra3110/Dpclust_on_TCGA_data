#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-A6-6654-01
library(dpclust3p)

sample <- "TCGA-A6-6654-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-A6-6654-01"
