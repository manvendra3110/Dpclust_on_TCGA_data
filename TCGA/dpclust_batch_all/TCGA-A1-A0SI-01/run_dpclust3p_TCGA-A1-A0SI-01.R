#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-A1-A0SI-01
library(dpclust3p)

sample <- "TCGA-A1-A0SI-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-A1-A0SI-01"
