#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-EU-5905-01
library(dpclust3p)

sample <- "TCGA-EU-5905-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-EU-5905-01"
