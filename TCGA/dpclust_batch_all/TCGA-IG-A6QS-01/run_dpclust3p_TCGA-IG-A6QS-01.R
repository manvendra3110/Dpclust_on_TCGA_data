#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IG-A6QS-01
library(dpclust3p)

sample <- "TCGA-IG-A6QS-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IG-A6QS-01"
