#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-GS-A9TT-01
library(dpclust3p)

sample <- "TCGA-GS-A9TT-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-GS-A9TT-01"
