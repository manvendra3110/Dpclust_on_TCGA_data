#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-SH-A7BC-01
library(dpclust3p)

sample <- "TCGA-SH-A7BC-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-SH-A7BC-01"
