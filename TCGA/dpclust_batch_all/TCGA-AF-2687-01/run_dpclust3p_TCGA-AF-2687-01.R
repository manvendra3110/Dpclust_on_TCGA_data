#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AF-2687-01
library(dpclust3p)

sample <- "TCGA-AF-2687-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AF-2687-01"
