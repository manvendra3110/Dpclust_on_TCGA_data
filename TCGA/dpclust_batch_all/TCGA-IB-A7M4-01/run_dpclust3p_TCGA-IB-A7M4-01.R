#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IB-A7M4-01
library(dpclust3p)

sample <- "TCGA-IB-A7M4-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IB-A7M4-01"
