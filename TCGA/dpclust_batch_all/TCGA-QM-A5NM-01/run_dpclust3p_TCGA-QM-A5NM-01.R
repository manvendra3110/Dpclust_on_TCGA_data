#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-QM-A5NM-01
library(dpclust3p)

sample <- "TCGA-QM-A5NM-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-QM-A5NM-01"
