#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-M8-A5N4-01
library(dpclust3p)

sample <- "TCGA-M8-A5N4-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-M8-A5N4-01"
