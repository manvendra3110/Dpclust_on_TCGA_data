#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-L6-A4EQ-01
library(dpclust3p)

sample <- "TCGA-L6-A4EQ-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-L6-A4EQ-01"
