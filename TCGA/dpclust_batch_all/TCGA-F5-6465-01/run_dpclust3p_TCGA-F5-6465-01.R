#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-F5-6465-01
library(dpclust3p)

sample <- "TCGA-F5-6465-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-F5-6465-01"
