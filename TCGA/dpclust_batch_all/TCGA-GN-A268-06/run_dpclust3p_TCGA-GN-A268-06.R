#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-GN-A268-06
library(dpclust3p)

sample <- "TCGA-GN-A268-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-GN-A268-06"
