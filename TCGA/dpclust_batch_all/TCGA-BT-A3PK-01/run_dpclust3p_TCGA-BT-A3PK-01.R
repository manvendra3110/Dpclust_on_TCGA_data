#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-BT-A3PK-01
library(dpclust3p)

sample <- "TCGA-BT-A3PK-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-BT-A3PK-01"
