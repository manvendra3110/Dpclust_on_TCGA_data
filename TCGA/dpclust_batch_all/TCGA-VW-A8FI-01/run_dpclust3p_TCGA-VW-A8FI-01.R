#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-VW-A8FI-01
library(dpclust3p)

sample <- "TCGA-VW-A8FI-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-VW-A8FI-01"
