#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DD-A4NK-01
library(dpclust3p)

sample <- "TCGA-DD-A4NK-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DD-A4NK-01"
