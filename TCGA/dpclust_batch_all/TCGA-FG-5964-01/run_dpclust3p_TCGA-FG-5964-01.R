#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-FG-5964-01
library(dpclust3p)

sample <- "TCGA-FG-5964-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-FG-5964-01"
