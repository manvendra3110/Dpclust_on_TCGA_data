#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-QH-A6XA-01
library(dpclust3p)

sample <- "TCGA-QH-A6XA-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-QH-A6XA-01"
