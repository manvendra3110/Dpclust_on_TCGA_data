#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-56-8628-01
library(dpclust3p)

sample <- "TCGA-56-8628-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-56-8628-01"
