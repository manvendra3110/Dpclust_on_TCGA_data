#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-QR-A70G-01
library(dpclust3p)

sample <- "TCGA-QR-A70G-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-QR-A70G-01"
