#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CA-5255-01
library(dpclust3p)

sample <- "TCGA-CA-5255-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CA-5255-01"
