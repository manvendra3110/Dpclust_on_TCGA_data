#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DW-7837-01
library(dpclust3p)

sample <- "TCGA-DW-7837-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DW-7837-01"
