#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-UC-A7PD-01
library(dpclust3p)

sample <- "TCGA-UC-A7PD-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-UC-A7PD-01"
