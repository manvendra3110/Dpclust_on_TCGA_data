#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-PC-A5DK-01
library(dpclust3p)

sample <- "TCGA-PC-A5DK-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-PC-A5DK-01"
