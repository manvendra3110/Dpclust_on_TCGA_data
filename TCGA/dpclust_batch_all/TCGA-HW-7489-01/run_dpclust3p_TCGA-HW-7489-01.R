#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-HW-7489-01
library(dpclust3p)

sample <- "TCGA-HW-7489-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-HW-7489-01"
