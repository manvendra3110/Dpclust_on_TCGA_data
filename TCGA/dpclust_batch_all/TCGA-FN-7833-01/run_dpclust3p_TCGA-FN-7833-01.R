#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-FN-7833-01
library(dpclust3p)

sample <- "TCGA-FN-7833-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-FN-7833-01"
