#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-3N-A9WB-06
library(dpclust3p)

sample <- "TCGA-3N-A9WB-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-3N-A9WB-06"
