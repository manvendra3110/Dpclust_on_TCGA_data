#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-OD-A75X-06
library(dpclust3p)

sample <- "TCGA-OD-A75X-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-OD-A75X-06"
