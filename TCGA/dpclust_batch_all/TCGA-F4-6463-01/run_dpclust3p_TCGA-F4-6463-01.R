#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-F4-6463-01
library(dpclust3p)

sample <- "TCGA-F4-6463-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-F4-6463-01"
