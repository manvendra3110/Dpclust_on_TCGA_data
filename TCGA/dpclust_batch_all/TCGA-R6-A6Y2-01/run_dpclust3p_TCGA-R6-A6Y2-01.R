#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-R6-A6Y2-01
library(dpclust3p)

sample <- "TCGA-R6-A6Y2-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-R6-A6Y2-01"
