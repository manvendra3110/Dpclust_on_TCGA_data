#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-WD-A7RX-01
library(dpclust3p)

sample <- "TCGA-WD-A7RX-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-WD-A7RX-01"
