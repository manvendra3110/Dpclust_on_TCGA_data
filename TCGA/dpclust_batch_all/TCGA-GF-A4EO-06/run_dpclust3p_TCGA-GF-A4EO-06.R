#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-GF-A4EO-06
library(dpclust3p)

sample <- "TCGA-GF-A4EO-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-GF-A4EO-06"
