#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-KK-A8II-01
library(dpclust3p)

sample <- "TCGA-KK-A8II-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-KK-A8II-01"
