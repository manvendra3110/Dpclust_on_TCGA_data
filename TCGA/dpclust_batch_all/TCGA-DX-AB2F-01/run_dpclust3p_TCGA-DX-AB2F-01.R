#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DX-AB2F-01
library(dpclust3p)

sample <- "TCGA-DX-AB2F-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DX-AB2F-01"
