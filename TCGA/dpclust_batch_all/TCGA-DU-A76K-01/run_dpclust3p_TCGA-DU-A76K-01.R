#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DU-A76K-01
library(dpclust3p)

sample <- "TCGA-DU-A76K-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DU-A76K-01"
