#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DE-A0Y2-01
library(dpclust3p)

sample <- "TCGA-DE-A0Y2-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DE-A0Y2-01"
