#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-MO-A47P-01
library(dpclust3p)

sample <- "TCGA-MO-A47P-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-MO-A47P-01"
