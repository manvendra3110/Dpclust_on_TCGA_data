#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-JW-A5VJ-01
library(dpclust3p)

sample <- "TCGA-JW-A5VJ-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-JW-A5VJ-01"
