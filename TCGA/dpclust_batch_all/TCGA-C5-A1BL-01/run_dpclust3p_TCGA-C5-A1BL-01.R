#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-C5-A1BL-01
library(dpclust3p)

sample <- "TCGA-C5-A1BL-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-C5-A1BL-01"
