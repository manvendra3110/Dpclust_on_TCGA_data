#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-P7-A5NY-01
library(dpclust3p)

sample <- "TCGA-P7-A5NY-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-P7-A5NY-01"
