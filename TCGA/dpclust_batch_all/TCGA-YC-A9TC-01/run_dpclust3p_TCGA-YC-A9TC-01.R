#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-YC-A9TC-01
library(dpclust3p)

sample <- "TCGA-YC-A9TC-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-YC-A9TC-01"
