#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-SQ-A6I6-01
library(dpclust3p)

sample <- "TCGA-SQ-A6I6-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-SQ-A6I6-01"
