#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CI-6622-01
library(dpclust3p)

sample <- "TCGA-CI-6622-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CI-6622-01"
