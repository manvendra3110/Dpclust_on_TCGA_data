#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AJ-A3TW-01
library(dpclust3p)

sample <- "TCGA-AJ-A3TW-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AJ-A3TW-01"
