#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-C8-A12W-01
library(dpclust3p)

sample <- "TCGA-C8-A12W-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-C8-A12W-01"
