#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-RS-A6TO-01
library(dpclust3p)

sample <- "TCGA-RS-A6TO-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-RS-A6TO-01"
