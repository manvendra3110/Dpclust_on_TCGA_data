#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-K6-A3WQ-01
library(dpclust3p)

sample <- "TCGA-K6-A3WQ-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-K6-A3WQ-01"
