#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-H7-A6C4-01
library(dpclust3p)

sample <- "TCGA-H7-A6C4-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-H7-A6C4-01"
