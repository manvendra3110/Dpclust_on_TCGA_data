#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DO-A1K0-01
library(dpclust3p)

sample <- "TCGA-DO-A1K0-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DO-A1K0-01"
