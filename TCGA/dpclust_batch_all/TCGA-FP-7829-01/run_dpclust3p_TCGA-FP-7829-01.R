#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-FP-7829-01
library(dpclust3p)

sample <- "TCGA-FP-7829-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-FP-7829-01"
