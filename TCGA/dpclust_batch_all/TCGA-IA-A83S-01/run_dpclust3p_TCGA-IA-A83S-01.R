#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IA-A83S-01
library(dpclust3p)

sample <- "TCGA-IA-A83S-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IA-A83S-01"
