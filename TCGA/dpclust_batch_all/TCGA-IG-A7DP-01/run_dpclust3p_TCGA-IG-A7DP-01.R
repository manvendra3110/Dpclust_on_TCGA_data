#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IG-A7DP-01
library(dpclust3p)

sample <- "TCGA-IG-A7DP-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IG-A7DP-01"
