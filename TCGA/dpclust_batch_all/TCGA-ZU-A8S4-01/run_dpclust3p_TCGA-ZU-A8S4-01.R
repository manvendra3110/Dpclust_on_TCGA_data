#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-ZU-A8S4-01
library(dpclust3p)

sample <- "TCGA-ZU-A8S4-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-ZU-A8S4-01"
