#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-EP-A3JL-01
library(dpclust3p)

sample <- "TCGA-EP-A3JL-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-EP-A3JL-01"
