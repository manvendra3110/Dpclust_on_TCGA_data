#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-X7-A8DB-01
library(dpclust3p)

sample <- "TCGA-X7-A8DB-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-X7-A8DB-01"
