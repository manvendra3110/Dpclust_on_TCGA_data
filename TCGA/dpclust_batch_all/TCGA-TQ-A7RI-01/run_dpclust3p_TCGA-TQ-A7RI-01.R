#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-TQ-A7RI-01
library(dpclust3p)

sample <- "TCGA-TQ-A7RI-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-TQ-A7RI-01"
