#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IB-7885-01
library(dpclust3p)

sample <- "TCGA-IB-7885-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IB-7885-01"
