#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-FF-8043-01
library(dpclust3p)

sample <- "TCGA-FF-8043-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-FF-8043-01"
