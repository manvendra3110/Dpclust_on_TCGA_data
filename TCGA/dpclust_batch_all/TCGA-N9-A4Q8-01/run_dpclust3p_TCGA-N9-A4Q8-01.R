#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-N9-A4Q8-01
library(dpclust3p)

sample <- "TCGA-N9-A4Q8-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-N9-A4Q8-01"
