#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-OR-A5K1-01
library(dpclust3p)

sample <- "TCGA-OR-A5K1-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-OR-A5K1-01"
