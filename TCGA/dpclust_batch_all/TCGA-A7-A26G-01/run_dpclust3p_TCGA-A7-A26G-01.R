#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-A7-A26G-01
library(dpclust3p)

sample <- "TCGA-A7-A26G-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-A7-A26G-01"
