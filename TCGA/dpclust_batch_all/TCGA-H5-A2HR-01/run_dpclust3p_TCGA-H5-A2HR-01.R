#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-H5-A2HR-01
library(dpclust3p)

sample <- "TCGA-H5-A2HR-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-H5-A2HR-01"
