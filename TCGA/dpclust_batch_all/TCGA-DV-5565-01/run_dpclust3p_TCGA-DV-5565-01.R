#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DV-5565-01
library(dpclust3p)

sample <- "TCGA-DV-5565-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DV-5565-01"
