#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-B9-5156-01
library(dpclust3p)

sample <- "TCGA-B9-5156-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-B9-5156-01"
