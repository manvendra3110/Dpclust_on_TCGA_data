#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-XF-A9T6-01
library(dpclust3p)

sample <- "TCGA-XF-A9T6-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-XF-A9T6-01"
