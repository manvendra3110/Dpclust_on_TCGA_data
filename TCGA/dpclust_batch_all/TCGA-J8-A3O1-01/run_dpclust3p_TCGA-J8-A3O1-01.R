#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-J8-A3O1-01
library(dpclust3p)

sample <- "TCGA-J8-A3O1-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-J8-A3O1-01"
