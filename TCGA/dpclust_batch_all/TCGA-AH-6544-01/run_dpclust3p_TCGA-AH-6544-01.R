#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AH-6544-01
library(dpclust3p)

sample <- "TCGA-AH-6544-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AH-6544-01"
