#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AS-3777-01
library(dpclust3p)

sample <- "TCGA-AS-3777-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AS-3777-01"
