#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-ER-A42L-06
library(dpclust3p)

sample <- "TCGA-ER-A42L-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-ER-A42L-06"
