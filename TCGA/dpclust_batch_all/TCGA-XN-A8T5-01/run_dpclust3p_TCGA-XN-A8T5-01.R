#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-XN-A8T5-01
library(dpclust3p)

sample <- "TCGA-XN-A8T5-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-XN-A8T5-01"
