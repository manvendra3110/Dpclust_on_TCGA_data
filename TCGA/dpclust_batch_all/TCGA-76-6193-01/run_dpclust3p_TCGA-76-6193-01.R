#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-76-6193-01
library(dpclust3p)

sample <- "TCGA-76-6193-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-76-6193-01"
