#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-NI-A8LF-01
library(dpclust3p)

sample <- "TCGA-NI-A8LF-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-NI-A8LF-01"
