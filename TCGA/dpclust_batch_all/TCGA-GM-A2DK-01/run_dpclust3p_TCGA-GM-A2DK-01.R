#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-GM-A2DK-01
library(dpclust3p)

sample <- "TCGA-GM-A2DK-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-GM-A2DK-01"
