#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-TN-A7HJ-01
library(dpclust3p)

sample <- "TCGA-TN-A7HJ-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-TN-A7HJ-01"
