#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DQ-5631-01
library(dpclust3p)

sample <- "TCGA-DQ-5631-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DQ-5631-01"
