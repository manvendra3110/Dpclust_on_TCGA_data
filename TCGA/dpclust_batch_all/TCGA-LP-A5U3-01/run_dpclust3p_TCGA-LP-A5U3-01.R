#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-LP-A5U3-01
library(dpclust3p)

sample <- "TCGA-LP-A5U3-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-LP-A5U3-01"
