#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-VQ-A91X-01
library(dpclust3p)

sample <- "TCGA-VQ-A91X-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-VQ-A91X-01"
