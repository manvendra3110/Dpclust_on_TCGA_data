#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-79-5596-01
library(dpclust3p)

sample <- "TCGA-79-5596-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-79-5596-01"
