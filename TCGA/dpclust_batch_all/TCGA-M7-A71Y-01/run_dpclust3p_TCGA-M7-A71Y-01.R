#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-M7-A71Y-01
library(dpclust3p)

sample <- "TCGA-M7-A71Y-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-M7-A71Y-01"
