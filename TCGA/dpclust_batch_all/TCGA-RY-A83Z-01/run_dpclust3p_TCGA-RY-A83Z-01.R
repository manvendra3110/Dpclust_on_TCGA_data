#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-RY-A83Z-01
library(dpclust3p)

sample <- "TCGA-RY-A83Z-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-RY-A83Z-01"
