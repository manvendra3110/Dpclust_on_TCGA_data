#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AL-7173-01
library(dpclust3p)

sample <- "TCGA-AL-7173-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AL-7173-01"
