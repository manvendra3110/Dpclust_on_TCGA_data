#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-ZN-A9VW-01
library(dpclust3p)

sample <- "TCGA-ZN-A9VW-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-ZN-A9VW-01"
