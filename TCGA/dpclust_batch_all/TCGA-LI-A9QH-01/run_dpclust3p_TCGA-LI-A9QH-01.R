#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-LI-A9QH-01
library(dpclust3p)

sample <- "TCGA-LI-A9QH-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-LI-A9QH-01"
