#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-HE-A5NH-01
library(dpclust3p)

sample <- "TCGA-HE-A5NH-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-HE-A5NH-01"
