#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-V1-A9O5-01
library(dpclust3p)

sample <- "TCGA-V1-A9O5-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-V1-A9O5-01"
