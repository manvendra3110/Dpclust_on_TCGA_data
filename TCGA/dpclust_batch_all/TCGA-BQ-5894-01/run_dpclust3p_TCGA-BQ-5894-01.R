#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-BQ-5894-01
library(dpclust3p)

sample <- "TCGA-BQ-5894-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-BQ-5894-01"
