#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-PL-A8LV-01
library(dpclust3p)

sample <- "TCGA-PL-A8LV-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-PL-A8LV-01"
