#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-EB-A4IQ-01
library(dpclust3p)

sample <- "TCGA-EB-A4IQ-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-EB-A4IQ-01"
