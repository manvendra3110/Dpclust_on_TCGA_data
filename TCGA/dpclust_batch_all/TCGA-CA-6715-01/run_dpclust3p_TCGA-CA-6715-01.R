#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CA-6715-01
library(dpclust3p)

sample <- "TCGA-CA-6715-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CA-6715-01"
