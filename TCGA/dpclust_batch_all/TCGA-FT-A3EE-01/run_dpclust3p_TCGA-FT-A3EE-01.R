#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-FT-A3EE-01
library(dpclust3p)

sample <- "TCGA-FT-A3EE-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-FT-A3EE-01"
