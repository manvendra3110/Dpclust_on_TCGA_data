#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-B0-4945-01
library(dpclust3p)

sample <- "TCGA-B0-4945-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-B0-4945-01"
