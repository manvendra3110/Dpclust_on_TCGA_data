#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-XY-A8S2-01
library(dpclust3p)

sample <- "TCGA-XY-A8S2-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-XY-A8S2-01"
