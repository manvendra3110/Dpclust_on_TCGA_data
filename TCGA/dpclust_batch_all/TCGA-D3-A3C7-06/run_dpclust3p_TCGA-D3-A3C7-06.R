#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-D3-A3C7-06
library(dpclust3p)

sample <- "TCGA-D3-A3C7-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-D3-A3C7-06"
