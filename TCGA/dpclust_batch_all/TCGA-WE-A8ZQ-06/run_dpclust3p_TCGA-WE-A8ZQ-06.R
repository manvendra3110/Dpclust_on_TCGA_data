#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-WE-A8ZQ-06
library(dpclust3p)

sample <- "TCGA-WE-A8ZQ-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-WE-A8ZQ-06"
