#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IW-A3M5-01
library(dpclust3p)

sample <- "TCGA-IW-A3M5-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IW-A3M5-01"
