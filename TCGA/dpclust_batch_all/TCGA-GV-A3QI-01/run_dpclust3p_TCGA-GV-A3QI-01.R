#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-GV-A3QI-01
library(dpclust3p)

sample <- "TCGA-GV-A3QI-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-GV-A3QI-01"
