#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-RE-A7BO-01
library(dpclust3p)

sample <- "TCGA-RE-A7BO-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-RE-A7BO-01"
