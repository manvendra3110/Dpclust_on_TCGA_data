#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AU-3779-01
library(dpclust3p)

sample <- "TCGA-AU-3779-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AU-3779-01"
