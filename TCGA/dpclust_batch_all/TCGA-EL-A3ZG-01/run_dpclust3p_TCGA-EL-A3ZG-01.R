#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-EL-A3ZG-01
library(dpclust3p)

sample <- "TCGA-EL-A3ZG-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-EL-A3ZG-01"
