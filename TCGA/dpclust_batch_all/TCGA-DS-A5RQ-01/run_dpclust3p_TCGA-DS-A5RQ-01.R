#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DS-A5RQ-01
library(dpclust3p)

sample <- "TCGA-DS-A5RQ-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DS-A5RQ-01"
