#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-SR-A6MQ-01
library(dpclust3p)

sample <- "TCGA-SR-A6MQ-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-SR-A6MQ-01"
