#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-HG-A2PA-01
library(dpclust3p)

sample <- "TCGA-HG-A2PA-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-HG-A2PA-01"
