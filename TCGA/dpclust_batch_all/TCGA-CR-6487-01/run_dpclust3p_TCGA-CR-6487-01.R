#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CR-6487-01
library(dpclust3p)

sample <- "TCGA-CR-6487-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CR-6487-01"
