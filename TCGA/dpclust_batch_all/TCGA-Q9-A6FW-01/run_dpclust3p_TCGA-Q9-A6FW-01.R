#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-Q9-A6FW-01
library(dpclust3p)

sample <- "TCGA-Q9-A6FW-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-Q9-A6FW-01"
