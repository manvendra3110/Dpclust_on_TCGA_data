#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-MQ-A6BL-01
library(dpclust3p)

sample <- "TCGA-MQ-A6BL-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-MQ-A6BL-01"
