#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-D1-A16R-01
library(dpclust3p)

sample <- "TCGA-D1-A16R-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-D1-A16R-01"
