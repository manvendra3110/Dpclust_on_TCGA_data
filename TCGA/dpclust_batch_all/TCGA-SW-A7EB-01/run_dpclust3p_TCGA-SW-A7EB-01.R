#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-SW-A7EB-01
library(dpclust3p)

sample <- "TCGA-SW-A7EB-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-SW-A7EB-01"
