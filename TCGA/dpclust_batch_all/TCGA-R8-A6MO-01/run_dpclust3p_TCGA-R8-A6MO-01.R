#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-R8-A6MO-01
library(dpclust3p)

sample <- "TCGA-R8-A6MO-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-R8-A6MO-01"
