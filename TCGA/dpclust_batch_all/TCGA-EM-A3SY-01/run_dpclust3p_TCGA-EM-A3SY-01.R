#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-EM-A3SY-01
library(dpclust3p)

sample <- "TCGA-EM-A3SY-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-EM-A3SY-01"
