#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-HN-A2NL-01
library(dpclust3p)

sample <- "TCGA-HN-A2NL-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-HN-A2NL-01"
