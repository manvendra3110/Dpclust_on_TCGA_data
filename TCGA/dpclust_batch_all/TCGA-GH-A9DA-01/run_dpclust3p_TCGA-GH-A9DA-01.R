#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-GH-A9DA-01
library(dpclust3p)

sample <- "TCGA-GH-A9DA-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-GH-A9DA-01"
