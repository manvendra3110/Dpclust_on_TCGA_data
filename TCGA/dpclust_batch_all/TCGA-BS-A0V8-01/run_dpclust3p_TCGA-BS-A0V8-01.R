#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-BS-A0V8-01
library(dpclust3p)

sample <- "TCGA-BS-A0V8-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-BS-A0V8-01"
