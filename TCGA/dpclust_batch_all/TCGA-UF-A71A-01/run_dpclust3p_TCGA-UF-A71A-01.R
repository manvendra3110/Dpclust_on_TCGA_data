#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-UF-A71A-01
library(dpclust3p)

sample <- "TCGA-UF-A71A-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-UF-A71A-01"
