#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CK-4950-01
library(dpclust3p)

sample <- "TCGA-CK-4950-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CK-4950-01"
