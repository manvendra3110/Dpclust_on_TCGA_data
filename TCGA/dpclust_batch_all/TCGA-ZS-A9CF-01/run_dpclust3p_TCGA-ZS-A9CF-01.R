#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-ZS-A9CF-01
library(dpclust3p)

sample <- "TCGA-ZS-A9CF-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-ZS-A9CF-01"
