#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-R5-A7ZF-01
library(dpclust3p)

sample <- "TCGA-R5-A7ZF-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-R5-A7ZF-01"
