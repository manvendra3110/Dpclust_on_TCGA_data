#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-G4-6320-01
library(dpclust3p)

sample <- "TCGA-G4-6320-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-G4-6320-01"
