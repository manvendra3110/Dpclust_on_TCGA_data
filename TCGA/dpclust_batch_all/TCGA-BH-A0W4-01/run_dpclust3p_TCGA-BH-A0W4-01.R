#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-BH-A0W4-01
library(dpclust3p)

sample <- "TCGA-BH-A0W4-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-BH-A0W4-01"
