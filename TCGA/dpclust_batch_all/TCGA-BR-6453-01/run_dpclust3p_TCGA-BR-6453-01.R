#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-BR-6453-01
library(dpclust3p)

sample <- "TCGA-BR-6453-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-BR-6453-01"
