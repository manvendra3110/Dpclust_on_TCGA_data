#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-A4-A4ZT-01
library(dpclust3p)

sample <- "TCGA-A4-A4ZT-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-A4-A4ZT-01"
