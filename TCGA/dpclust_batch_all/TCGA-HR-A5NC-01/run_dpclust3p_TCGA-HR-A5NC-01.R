#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-HR-A5NC-01
library(dpclust3p)

sample <- "TCGA-HR-A5NC-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-HR-A5NC-01"
