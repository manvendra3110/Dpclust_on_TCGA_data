#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DY-A1DD-01
library(dpclust3p)

sample <- "TCGA-DY-A1DD-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DY-A1DD-01"
