#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-PG-A7D5-01
library(dpclust3p)

sample <- "TCGA-PG-A7D5-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-PG-A7D5-01"
