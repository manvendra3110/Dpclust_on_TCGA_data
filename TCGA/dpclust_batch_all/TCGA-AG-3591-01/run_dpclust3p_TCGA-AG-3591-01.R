#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AG-3591-01
library(dpclust3p)

sample <- "TCGA-AG-3591-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AG-3591-01"
