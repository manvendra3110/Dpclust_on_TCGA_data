#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-RG-A7D4-01
library(dpclust3p)

sample <- "TCGA-RG-A7D4-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-RG-A7D4-01"
