#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-MT-A7BN-01
library(dpclust3p)

sample <- "TCGA-MT-A7BN-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-MT-A7BN-01"
