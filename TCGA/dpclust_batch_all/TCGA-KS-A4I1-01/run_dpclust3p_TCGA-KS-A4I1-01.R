#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-KS-A4I1-01
library(dpclust3p)

sample <- "TCGA-KS-A4I1-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-KS-A4I1-01"
