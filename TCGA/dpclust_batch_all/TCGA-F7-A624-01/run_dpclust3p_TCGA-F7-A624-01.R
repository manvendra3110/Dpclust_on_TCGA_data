#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-F7-A624-01
library(dpclust3p)

sample <- "TCGA-F7-A624-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-F7-A624-01"
