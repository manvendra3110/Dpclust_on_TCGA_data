#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-ZF-AA4N-01
library(dpclust3p)

sample <- "TCGA-ZF-AA4N-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-ZF-AA4N-01"
