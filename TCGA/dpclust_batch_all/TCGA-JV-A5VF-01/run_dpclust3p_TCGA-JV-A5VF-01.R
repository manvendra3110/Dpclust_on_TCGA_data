#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-JV-A5VF-01
library(dpclust3p)

sample <- "TCGA-JV-A5VF-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-JV-A5VF-01"
