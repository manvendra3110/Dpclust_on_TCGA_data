#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-PR-A5PG-01
library(dpclust3p)

sample <- "TCGA-PR-A5PG-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-PR-A5PG-01"
