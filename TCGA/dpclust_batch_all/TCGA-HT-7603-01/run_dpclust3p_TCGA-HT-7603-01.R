#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-HT-7603-01
library(dpclust3p)

sample <- "TCGA-HT-7603-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-HT-7603-01"
