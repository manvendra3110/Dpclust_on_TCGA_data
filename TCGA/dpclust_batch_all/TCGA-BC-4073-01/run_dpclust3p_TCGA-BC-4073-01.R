#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-BC-4073-01
library(dpclust3p)

sample <- "TCGA-BC-4073-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-BC-4073-01"
