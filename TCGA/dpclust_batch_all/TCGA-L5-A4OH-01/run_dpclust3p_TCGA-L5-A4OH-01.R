#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-L5-A4OH-01
library(dpclust3p)

sample <- "TCGA-L5-A4OH-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-L5-A4OH-01"
