#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-HI-7171-01
library(dpclust3p)

sample <- "TCGA-HI-7171-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-HI-7171-01"
