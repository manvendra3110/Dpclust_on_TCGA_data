#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-WZ-A7V3-01
library(dpclust3p)

sample <- "TCGA-WZ-A7V3-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-WZ-A7V3-01"
