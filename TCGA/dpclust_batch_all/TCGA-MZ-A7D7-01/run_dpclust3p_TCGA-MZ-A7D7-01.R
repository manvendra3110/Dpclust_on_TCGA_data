#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-MZ-A7D7-01
library(dpclust3p)

sample <- "TCGA-MZ-A7D7-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-MZ-A7D7-01"
