#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-VR-A8EU-01
library(dpclust3p)

sample <- "TCGA-VR-A8EU-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-VR-A8EU-01"
