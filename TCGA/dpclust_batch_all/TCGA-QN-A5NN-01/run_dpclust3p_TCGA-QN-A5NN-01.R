#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-QN-A5NN-01
library(dpclust3p)

sample <- "TCGA-QN-A5NN-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-QN-A5NN-01"
