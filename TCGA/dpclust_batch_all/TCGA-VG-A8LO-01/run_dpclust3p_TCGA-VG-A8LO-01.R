#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-VG-A8LO-01
library(dpclust3p)

sample <- "TCGA-VG-A8LO-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-VG-A8LO-01"
