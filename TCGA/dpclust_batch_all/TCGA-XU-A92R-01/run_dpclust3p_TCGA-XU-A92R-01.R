#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-XU-A92R-01
library(dpclust3p)

sample <- "TCGA-XU-A92R-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-XU-A92R-01"
