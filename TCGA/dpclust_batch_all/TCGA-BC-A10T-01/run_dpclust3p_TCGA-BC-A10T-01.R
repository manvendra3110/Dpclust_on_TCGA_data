#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-BC-A10T-01
library(dpclust3p)

sample <- "TCGA-BC-A10T-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-BC-A10T-01"
