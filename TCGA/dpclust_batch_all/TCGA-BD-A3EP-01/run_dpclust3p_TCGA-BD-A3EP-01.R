#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-BD-A3EP-01
library(dpclust3p)

sample <- "TCGA-BD-A3EP-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-BD-A3EP-01"
