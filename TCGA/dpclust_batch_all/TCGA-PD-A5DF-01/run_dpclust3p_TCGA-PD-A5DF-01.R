#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-PD-A5DF-01
library(dpclust3p)

sample <- "TCGA-PD-A5DF-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-PD-A5DF-01"
