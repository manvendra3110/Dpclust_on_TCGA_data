#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-KH-A6WC-01
library(dpclust3p)

sample <- "TCGA-KH-A6WC-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-KH-A6WC-01"
