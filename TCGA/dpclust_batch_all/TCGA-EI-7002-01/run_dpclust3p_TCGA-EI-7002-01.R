#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-EI-7002-01
library(dpclust3p)

sample <- "TCGA-EI-7002-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-EI-7002-01"
