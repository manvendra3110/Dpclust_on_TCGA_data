#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-NC-A5HG-01
library(dpclust3p)

sample <- "TCGA-NC-A5HG-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-NC-A5HG-01"
