#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-GJ-A6C0-01
library(dpclust3p)

sample <- "TCGA-GJ-A6C0-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-GJ-A6C0-01"
