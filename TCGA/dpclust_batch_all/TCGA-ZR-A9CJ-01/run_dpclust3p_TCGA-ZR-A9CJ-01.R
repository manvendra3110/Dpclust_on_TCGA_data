#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-ZR-A9CJ-01
library(dpclust3p)

sample <- "TCGA-ZR-A9CJ-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-ZR-A9CJ-01"
