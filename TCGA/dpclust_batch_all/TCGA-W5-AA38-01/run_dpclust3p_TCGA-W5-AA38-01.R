#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-W5-AA38-01
library(dpclust3p)

sample <- "TCGA-W5-AA38-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-W5-AA38-01"
