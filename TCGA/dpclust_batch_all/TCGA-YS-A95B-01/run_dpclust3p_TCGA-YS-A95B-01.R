#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-YS-A95B-01
library(dpclust3p)

sample <- "TCGA-YS-A95B-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-YS-A95B-01"
