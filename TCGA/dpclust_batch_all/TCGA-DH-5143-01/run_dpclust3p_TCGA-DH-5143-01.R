#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DH-5143-01
library(dpclust3p)

sample <- "TCGA-DH-5143-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DH-5143-01"
