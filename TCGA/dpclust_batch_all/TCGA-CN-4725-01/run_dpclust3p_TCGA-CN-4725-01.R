#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CN-4725-01
library(dpclust3p)

sample <- "TCGA-CN-4725-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CN-4725-01"
