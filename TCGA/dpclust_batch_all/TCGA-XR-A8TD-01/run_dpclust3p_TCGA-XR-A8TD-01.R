#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-XR-A8TD-01
library(dpclust3p)

sample <- "TCGA-XR-A8TD-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-XR-A8TD-01"
