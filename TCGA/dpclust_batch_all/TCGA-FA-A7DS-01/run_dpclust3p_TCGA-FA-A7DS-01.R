#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-FA-A7DS-01
library(dpclust3p)

sample <- "TCGA-FA-A7DS-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-FA-A7DS-01"
