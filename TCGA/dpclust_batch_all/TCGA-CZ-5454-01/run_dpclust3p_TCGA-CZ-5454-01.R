#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CZ-5454-01
library(dpclust3p)

sample <- "TCGA-CZ-5454-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CZ-5454-01"
