#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CX-7219-01
library(dpclust3p)

sample <- "TCGA-CX-7219-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CX-7219-01"
