#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-HU-8608-01
library(dpclust3p)

sample <- "TCGA-HU-8608-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-HU-8608-01"
