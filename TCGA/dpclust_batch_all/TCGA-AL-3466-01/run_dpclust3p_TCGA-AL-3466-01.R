#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AL-3466-01
library(dpclust3p)

sample <- "TCGA-AL-3466-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AL-3466-01"
