#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-UZ-A9PS-01
library(dpclust3p)

sample <- "TCGA-UZ-A9PS-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-UZ-A9PS-01"
