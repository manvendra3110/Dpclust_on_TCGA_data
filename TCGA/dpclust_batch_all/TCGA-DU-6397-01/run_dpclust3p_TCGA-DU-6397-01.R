#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DU-6397-01
library(dpclust3p)

sample <- "TCGA-DU-6397-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DU-6397-01"
