#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AF-3911-01
library(dpclust3p)

sample <- "TCGA-AF-3911-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AF-3911-01"
