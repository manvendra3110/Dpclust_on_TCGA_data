#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-Y6-A9XI-01
library(dpclust3p)

sample <- "TCGA-Y6-A9XI-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-Y6-A9XI-01"
