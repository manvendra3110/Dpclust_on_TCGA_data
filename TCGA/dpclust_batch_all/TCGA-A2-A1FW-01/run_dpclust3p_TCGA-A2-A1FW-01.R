#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-A2-A1FW-01
library(dpclust3p)

sample <- "TCGA-A2-A1FW-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-A2-A1FW-01"
