#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-LT-A8JT-01
library(dpclust3p)

sample <- "TCGA-LT-A8JT-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-LT-A8JT-01"
