#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-LL-A73Y-01
library(dpclust3p)

sample <- "TCGA-LL-A73Y-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-LL-A73Y-01"
