#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AX-A2HH-01
library(dpclust3p)

sample <- "TCGA-AX-A2HH-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AX-A2HH-01"
