#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-P8-A5KD-01
library(dpclust3p)

sample <- "TCGA-P8-A5KD-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-P8-A5KD-01"
