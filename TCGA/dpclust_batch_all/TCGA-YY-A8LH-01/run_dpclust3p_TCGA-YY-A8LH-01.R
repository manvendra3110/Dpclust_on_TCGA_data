#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-YY-A8LH-01
library(dpclust3p)

sample <- "TCGA-YY-A8LH-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-YY-A8LH-01"
