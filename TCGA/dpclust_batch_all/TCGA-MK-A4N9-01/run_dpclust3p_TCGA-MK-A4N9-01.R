#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-MK-A4N9-01
library(dpclust3p)

sample <- "TCGA-MK-A4N9-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-MK-A4N9-01"
