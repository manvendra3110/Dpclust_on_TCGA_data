#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-V4-A9E9-01
library(dpclust3p)

sample <- "TCGA-V4-A9E9-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-V4-A9E9-01"
