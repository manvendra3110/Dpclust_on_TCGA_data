#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AN-A0XV-01
library(dpclust3p)

sample <- "TCGA-AN-A0XV-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AN-A0XV-01"
