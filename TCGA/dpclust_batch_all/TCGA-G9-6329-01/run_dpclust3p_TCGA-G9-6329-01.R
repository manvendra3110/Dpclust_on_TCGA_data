#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-G9-6329-01
library(dpclust3p)

sample <- "TCGA-G9-6329-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-G9-6329-01"
