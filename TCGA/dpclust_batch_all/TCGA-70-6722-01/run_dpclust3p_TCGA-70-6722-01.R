#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-70-6722-01
library(dpclust3p)

sample <- "TCGA-70-6722-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-70-6722-01"
