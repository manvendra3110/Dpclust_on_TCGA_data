#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-QU-A6IN-01
library(dpclust3p)

sample <- "TCGA-QU-A6IN-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-QU-A6IN-01"
