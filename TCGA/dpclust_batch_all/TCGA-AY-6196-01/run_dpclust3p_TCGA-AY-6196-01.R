#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AY-6196-01
library(dpclust3p)

sample <- "TCGA-AY-6196-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AY-6196-01"
