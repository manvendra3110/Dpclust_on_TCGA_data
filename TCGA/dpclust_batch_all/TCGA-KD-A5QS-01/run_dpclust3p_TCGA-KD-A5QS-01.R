#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-KD-A5QS-01
library(dpclust3p)

sample <- "TCGA-KD-A5QS-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-KD-A5QS-01"
