#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-GF-A6C9-06
library(dpclust3p)

sample <- "TCGA-GF-A6C9-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-GF-A6C9-06"
