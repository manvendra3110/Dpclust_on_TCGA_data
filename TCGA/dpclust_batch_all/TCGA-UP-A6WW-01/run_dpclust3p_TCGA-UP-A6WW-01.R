#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-UP-A6WW-01
library(dpclust3p)

sample <- "TCGA-UP-A6WW-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-UP-A6WW-01"
