#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AP-A1E0-01
library(dpclust3p)

sample <- "TCGA-AP-A1E0-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AP-A1E0-01"
