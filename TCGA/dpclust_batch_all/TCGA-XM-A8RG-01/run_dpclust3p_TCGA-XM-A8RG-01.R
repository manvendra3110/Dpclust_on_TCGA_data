#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-XM-A8RG-01
library(dpclust3p)

sample <- "TCGA-XM-A8RG-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-XM-A8RG-01"
