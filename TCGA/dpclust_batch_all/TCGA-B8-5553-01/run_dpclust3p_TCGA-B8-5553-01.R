#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-B8-5553-01
library(dpclust3p)

sample <- "TCGA-B8-5553-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-B8-5553-01"
