#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IZ-A6M9-01
library(dpclust3p)

sample <- "TCGA-IZ-A6M9-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IZ-A6M9-01"
