#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-GL-8500-01
library(dpclust3p)

sample <- "TCGA-GL-8500-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-GL-8500-01"
