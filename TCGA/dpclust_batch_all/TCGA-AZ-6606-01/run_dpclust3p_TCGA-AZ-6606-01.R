#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AZ-6606-01
library(dpclust3p)

sample <- "TCGA-AZ-6606-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AZ-6606-01"
