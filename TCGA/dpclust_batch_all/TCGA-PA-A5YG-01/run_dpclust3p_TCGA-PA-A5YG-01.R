#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-PA-A5YG-01
library(dpclust3p)

sample <- "TCGA-PA-A5YG-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-PA-A5YG-01"
