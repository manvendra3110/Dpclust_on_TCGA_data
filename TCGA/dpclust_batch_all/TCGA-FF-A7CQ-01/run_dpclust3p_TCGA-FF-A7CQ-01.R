#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-FF-A7CQ-01
library(dpclust3p)

sample <- "TCGA-FF-A7CQ-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-FF-A7CQ-01"
