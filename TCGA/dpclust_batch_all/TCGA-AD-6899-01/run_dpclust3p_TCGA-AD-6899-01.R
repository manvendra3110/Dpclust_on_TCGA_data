#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AD-6899-01
library(dpclust3p)

sample <- "TCGA-AD-6899-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AD-6899-01"
