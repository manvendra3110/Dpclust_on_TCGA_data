#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DI-A1C3-01
library(dpclust3p)

sample <- "TCGA-DI-A1C3-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DI-A1C3-01"
