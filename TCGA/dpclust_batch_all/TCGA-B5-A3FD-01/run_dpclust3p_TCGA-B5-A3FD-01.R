#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-B5-A3FD-01
library(dpclust3p)

sample <- "TCGA-B5-A3FD-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-B5-A3FD-01"
