#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DF-A2KV-01
library(dpclust3p)

sample <- "TCGA-DF-A2KV-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DF-A2KV-01"
