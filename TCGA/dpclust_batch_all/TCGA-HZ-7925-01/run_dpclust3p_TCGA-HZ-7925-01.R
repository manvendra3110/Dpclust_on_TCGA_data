#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-HZ-7925-01
library(dpclust3p)

sample <- "TCGA-HZ-7925-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-HZ-7925-01"
