#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-GC-A6I1-01
library(dpclust3p)

sample <- "TCGA-GC-A6I1-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-GC-A6I1-01"
