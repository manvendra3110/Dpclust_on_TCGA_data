#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CC-5263-01
library(dpclust3p)

sample <- "TCGA-CC-5263-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CC-5263-01"
