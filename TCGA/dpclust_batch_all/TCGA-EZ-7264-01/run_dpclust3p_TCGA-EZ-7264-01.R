#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-EZ-7264-01
library(dpclust3p)

sample <- "TCGA-EZ-7264-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-EZ-7264-01"
