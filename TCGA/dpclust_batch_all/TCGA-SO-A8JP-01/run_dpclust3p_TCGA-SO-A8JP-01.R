#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-SO-A8JP-01
library(dpclust3p)

sample <- "TCGA-SO-A8JP-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-SO-A8JP-01"
