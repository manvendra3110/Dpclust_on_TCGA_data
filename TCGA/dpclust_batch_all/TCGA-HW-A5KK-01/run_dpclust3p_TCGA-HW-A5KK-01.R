#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-HW-A5KK-01
library(dpclust3p)

sample <- "TCGA-HW-A5KK-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-HW-A5KK-01"
