#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-PE-A5DE-01
library(dpclust3p)

sample <- "TCGA-PE-A5DE-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-PE-A5DE-01"
