#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-ZP-A9D1-01
library(dpclust3p)

sample <- "TCGA-ZP-A9D1-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-ZP-A9D1-01"
