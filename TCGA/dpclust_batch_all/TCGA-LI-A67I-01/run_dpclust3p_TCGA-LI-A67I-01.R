#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-LI-A67I-01
library(dpclust3p)

sample <- "TCGA-LI-A67I-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-LI-A67I-01"
