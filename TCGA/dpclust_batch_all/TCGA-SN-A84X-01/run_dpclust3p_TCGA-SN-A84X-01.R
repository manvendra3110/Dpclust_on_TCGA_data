#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-SN-A84X-01
library(dpclust3p)

sample <- "TCGA-SN-A84X-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-SN-A84X-01"
