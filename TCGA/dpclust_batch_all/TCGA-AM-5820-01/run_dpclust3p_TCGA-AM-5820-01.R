#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AM-5820-01
library(dpclust3p)

sample <- "TCGA-AM-5820-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AM-5820-01"
