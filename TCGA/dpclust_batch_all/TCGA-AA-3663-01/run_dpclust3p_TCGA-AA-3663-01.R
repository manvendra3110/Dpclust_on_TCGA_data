#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AA-3663-01
library(dpclust3p)

sample <- "TCGA-AA-3663-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AA-3663-01"
