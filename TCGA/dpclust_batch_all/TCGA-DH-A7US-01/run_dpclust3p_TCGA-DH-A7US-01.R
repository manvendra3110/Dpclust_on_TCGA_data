#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DH-A7US-01
library(dpclust3p)

sample <- "TCGA-DH-A7US-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DH-A7US-01"
