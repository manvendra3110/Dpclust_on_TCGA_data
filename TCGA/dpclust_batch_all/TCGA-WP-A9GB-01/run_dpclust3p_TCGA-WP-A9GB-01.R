#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-WP-A9GB-01
library(dpclust3p)

sample <- "TCGA-WP-A9GB-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-WP-A9GB-01"
