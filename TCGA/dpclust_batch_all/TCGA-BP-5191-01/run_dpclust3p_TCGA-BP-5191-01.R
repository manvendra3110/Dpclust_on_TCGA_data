#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-BP-5191-01
library(dpclust3p)

sample <- "TCGA-BP-5191-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-BP-5191-01"
