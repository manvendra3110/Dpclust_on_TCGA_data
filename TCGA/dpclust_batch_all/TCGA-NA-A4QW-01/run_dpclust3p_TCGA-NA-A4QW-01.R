#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-NA-A4QW-01
library(dpclust3p)

sample <- "TCGA-NA-A4QW-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-NA-A4QW-01"
