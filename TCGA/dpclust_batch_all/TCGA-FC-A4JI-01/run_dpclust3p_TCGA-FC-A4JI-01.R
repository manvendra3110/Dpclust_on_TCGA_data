#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-FC-A4JI-01
library(dpclust3p)

sample <- "TCGA-FC-A4JI-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-FC-A4JI-01"
