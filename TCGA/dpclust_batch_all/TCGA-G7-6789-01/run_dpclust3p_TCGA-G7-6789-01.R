#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-G7-6789-01
library(dpclust3p)

sample <- "TCGA-G7-6789-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-G7-6789-01"
