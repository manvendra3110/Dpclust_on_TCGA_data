#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CM-6679-01
library(dpclust3p)

sample <- "TCGA-CM-6679-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CM-6679-01"
