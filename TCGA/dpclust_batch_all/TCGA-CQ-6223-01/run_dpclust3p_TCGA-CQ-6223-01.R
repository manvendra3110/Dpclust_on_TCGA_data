#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CQ-6223-01
library(dpclust3p)

sample <- "TCGA-CQ-6223-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CQ-6223-01"
