#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-FS-A1YX-06
library(dpclust3p)

sample <- "TCGA-FS-A1YX-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-FS-A1YX-06"
