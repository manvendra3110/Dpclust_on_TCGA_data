#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IR-A3LF-01
library(dpclust3p)

sample <- "TCGA-IR-A3LF-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IR-A3LF-01"
