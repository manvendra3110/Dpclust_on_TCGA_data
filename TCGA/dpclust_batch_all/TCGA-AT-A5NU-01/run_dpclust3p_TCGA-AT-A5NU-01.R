#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AT-A5NU-01
library(dpclust3p)

sample <- "TCGA-AT-A5NU-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AT-A5NU-01"
