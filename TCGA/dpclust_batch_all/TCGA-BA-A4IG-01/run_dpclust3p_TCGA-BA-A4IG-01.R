#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-BA-A4IG-01
library(dpclust3p)

sample <- "TCGA-BA-A4IG-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-BA-A4IG-01"
