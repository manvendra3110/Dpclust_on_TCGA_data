#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CV-5432-01
library(dpclust3p)

sample <- "TCGA-CV-5432-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CV-5432-01"
