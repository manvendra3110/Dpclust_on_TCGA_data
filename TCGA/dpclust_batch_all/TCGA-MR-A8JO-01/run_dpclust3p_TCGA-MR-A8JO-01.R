#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-MR-A8JO-01
library(dpclust3p)

sample <- "TCGA-MR-A8JO-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-MR-A8JO-01"
