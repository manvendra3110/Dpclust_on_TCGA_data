#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AK-3458-01
library(dpclust3p)

sample <- "TCGA-AK-3458-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AK-3458-01"
