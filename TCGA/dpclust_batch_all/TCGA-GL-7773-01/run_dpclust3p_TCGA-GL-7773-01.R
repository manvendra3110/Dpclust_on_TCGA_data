#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-GL-7773-01
library(dpclust3p)

sample <- "TCGA-GL-7773-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-GL-7773-01"
