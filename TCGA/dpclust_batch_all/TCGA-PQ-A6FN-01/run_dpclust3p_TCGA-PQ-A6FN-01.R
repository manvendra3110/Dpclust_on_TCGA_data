#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-PQ-A6FN-01
library(dpclust3p)

sample <- "TCGA-PQ-A6FN-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-PQ-A6FN-01"
