#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-KT-A74X-01
library(dpclust3p)

sample <- "TCGA-KT-A74X-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-KT-A74X-01"
