#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-YD-A9TB-06
library(dpclust3p)

sample <- "TCGA-YD-A9TB-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-YD-A9TB-06"
