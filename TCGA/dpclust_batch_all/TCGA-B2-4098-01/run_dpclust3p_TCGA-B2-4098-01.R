#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-B2-4098-01
library(dpclust3p)

sample <- "TCGA-B2-4098-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-B2-4098-01"
