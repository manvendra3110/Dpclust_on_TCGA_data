#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-Y8-A8S1-01
library(dpclust3p)

sample <- "TCGA-Y8-A8S1-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-Y8-A8S1-01"
