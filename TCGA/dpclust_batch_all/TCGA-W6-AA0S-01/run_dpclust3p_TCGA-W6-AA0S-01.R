#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-W6-AA0S-01
library(dpclust3p)

sample <- "TCGA-W6-AA0S-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-W6-AA0S-01"
