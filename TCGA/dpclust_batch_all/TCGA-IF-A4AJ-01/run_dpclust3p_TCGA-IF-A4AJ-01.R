#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IF-A4AJ-01
library(dpclust3p)

sample <- "TCGA-IF-A4AJ-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IF-A4AJ-01"
