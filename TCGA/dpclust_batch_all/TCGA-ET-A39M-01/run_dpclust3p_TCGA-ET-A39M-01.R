#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-ET-A39M-01
library(dpclust3p)

sample <- "TCGA-ET-A39M-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-ET-A39M-01"
