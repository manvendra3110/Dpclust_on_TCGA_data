#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CQ-A4CB-01
library(dpclust3p)

sample <- "TCGA-CQ-A4CB-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CQ-A4CB-01"
