#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-FI-A2CY-01
library(dpclust3p)

sample <- "TCGA-FI-A2CY-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-FI-A2CY-01"
