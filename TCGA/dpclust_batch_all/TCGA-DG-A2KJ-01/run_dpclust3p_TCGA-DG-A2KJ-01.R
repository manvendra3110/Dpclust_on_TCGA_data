#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DG-A2KJ-01
library(dpclust3p)

sample <- "TCGA-DG-A2KJ-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DG-A2KJ-01"
