#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IC-A6RE-01
library(dpclust3p)

sample <- "TCGA-IC-A6RE-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IC-A6RE-01"
