#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-Q3-A5QY-01
library(dpclust3p)

sample <- "TCGA-Q3-A5QY-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-Q3-A5QY-01"
