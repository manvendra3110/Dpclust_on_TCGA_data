#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-LH-A9QB-06
library(dpclust3p)

sample <- "TCGA-LH-A9QB-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-LH-A9QB-06"
