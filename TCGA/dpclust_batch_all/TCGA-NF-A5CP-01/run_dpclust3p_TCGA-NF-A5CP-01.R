#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-NF-A5CP-01
library(dpclust3p)

sample <- "TCGA-NF-A5CP-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-NF-A5CP-01"
