#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DC-6160-01
library(dpclust3p)

sample <- "TCGA-DC-6160-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DC-6160-01"
