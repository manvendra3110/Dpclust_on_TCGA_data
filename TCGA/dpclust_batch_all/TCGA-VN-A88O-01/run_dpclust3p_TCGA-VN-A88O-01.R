#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-VN-A88O-01
library(dpclust3p)

sample <- "TCGA-VN-A88O-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-VN-A88O-01"
