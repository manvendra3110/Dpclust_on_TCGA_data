#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-UB-A7MA-01
library(dpclust3p)

sample <- "TCGA-UB-A7MA-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-UB-A7MA-01"
