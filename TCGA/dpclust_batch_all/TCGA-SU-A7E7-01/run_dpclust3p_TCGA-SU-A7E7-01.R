#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-SU-A7E7-01
library(dpclust3p)

sample <- "TCGA-SU-A7E7-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-SU-A7E7-01"
