#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-H2-A2K9-01
library(dpclust3p)

sample <- "TCGA-H2-A2K9-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-H2-A2K9-01"
