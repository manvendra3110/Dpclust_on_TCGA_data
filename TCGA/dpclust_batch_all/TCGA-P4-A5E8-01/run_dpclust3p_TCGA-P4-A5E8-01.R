#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-P4-A5E8-01
library(dpclust3p)

sample <- "TCGA-P4-A5E8-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-P4-A5E8-01"
