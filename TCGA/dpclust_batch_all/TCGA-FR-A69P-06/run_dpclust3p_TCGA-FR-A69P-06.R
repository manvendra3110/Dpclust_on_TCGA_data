#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-FR-A69P-06
library(dpclust3p)

sample <- "TCGA-FR-A69P-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-FR-A69P-06"
