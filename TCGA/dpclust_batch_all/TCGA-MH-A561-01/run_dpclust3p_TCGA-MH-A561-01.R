#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-MH-A561-01
library(dpclust3p)

sample <- "TCGA-MH-A561-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-MH-A561-01"
