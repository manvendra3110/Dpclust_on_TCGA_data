#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-HQ-A2OE-01
library(dpclust3p)

sample <- "TCGA-HQ-A2OE-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-HQ-A2OE-01"
