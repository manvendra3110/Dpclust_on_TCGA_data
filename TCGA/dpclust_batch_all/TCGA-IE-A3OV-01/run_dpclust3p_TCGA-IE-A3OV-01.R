#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IE-A3OV-01
library(dpclust3p)

sample <- "TCGA-IE-A3OV-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IE-A3OV-01"
