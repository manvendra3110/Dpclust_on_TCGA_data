#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-22-5483-01
library(dpclust3p)

sample <- "TCGA-22-5483-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-22-5483-01"
