#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DM-A0XD-01
library(dpclust3p)

sample <- "TCGA-DM-A0XD-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DM-A0XD-01"
