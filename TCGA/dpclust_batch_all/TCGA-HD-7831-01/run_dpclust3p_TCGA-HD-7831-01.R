#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-HD-7831-01
library(dpclust3p)

sample <- "TCGA-HD-7831-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-HD-7831-01"
