#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-YL-A8HM-01
library(dpclust3p)

sample <- "TCGA-YL-A8HM-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-YL-A8HM-01"
