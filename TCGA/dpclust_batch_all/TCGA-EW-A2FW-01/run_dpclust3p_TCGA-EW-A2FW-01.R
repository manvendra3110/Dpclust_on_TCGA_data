#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-EW-A2FW-01
library(dpclust3p)

sample <- "TCGA-EW-A2FW-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-EW-A2FW-01"
