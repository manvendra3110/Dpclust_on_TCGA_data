#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CH-5768-01
library(dpclust3p)

sample <- "TCGA-CH-5768-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CH-5768-01"
