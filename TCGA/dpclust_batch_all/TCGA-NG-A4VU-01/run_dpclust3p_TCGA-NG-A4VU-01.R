#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-NG-A4VU-01
library(dpclust3p)

sample <- "TCGA-NG-A4VU-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-NG-A4VU-01"
