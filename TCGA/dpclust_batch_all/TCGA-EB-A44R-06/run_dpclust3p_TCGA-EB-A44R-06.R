#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-EB-A44R-06
library(dpclust3p)

sample <- "TCGA-EB-A44R-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-EB-A44R-06"
