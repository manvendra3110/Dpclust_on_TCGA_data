#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AC-A3HN-01
library(dpclust3p)

sample <- "TCGA-AC-A3HN-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AC-A3HN-01"
