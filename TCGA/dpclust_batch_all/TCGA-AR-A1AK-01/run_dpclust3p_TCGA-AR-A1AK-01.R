#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AR-A1AK-01
library(dpclust3p)

sample <- "TCGA-AR-A1AK-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AR-A1AK-01"
