#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CG-4443-01
library(dpclust3p)

sample <- "TCGA-CG-4443-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CG-4443-01"
