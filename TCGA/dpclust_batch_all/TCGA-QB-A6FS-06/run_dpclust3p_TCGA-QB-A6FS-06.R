#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-QB-A6FS-06
library(dpclust3p)

sample <- "TCGA-QB-A6FS-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-QB-A6FS-06"
