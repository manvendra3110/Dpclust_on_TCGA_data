#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-ZB-A96R-01
library(dpclust3p)

sample <- "TCGA-ZB-A96R-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-ZB-A96R-01"
