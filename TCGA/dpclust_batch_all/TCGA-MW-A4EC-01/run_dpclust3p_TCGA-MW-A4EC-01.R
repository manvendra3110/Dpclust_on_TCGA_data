#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-MW-A4EC-01
library(dpclust3p)

sample <- "TCGA-MW-A4EC-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-MW-A4EC-01"
