#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-QS-A744-01
library(dpclust3p)

sample <- "TCGA-QS-A744-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-QS-A744-01"
