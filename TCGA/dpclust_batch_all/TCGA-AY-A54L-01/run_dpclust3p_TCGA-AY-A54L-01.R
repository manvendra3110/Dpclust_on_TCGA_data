#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AY-A54L-01
library(dpclust3p)

sample <- "TCGA-AY-A54L-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AY-A54L-01"
