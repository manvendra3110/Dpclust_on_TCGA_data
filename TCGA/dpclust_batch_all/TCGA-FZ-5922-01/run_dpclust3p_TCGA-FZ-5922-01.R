#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-FZ-5922-01
library(dpclust3p)

sample <- "TCGA-FZ-5922-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-FZ-5922-01"
