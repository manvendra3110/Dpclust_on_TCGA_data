#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IH-A3EA-01
library(dpclust3p)

sample <- "TCGA-IH-A3EA-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IH-A3EA-01"
