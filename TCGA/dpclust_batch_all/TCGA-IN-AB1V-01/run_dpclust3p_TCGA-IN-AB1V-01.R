#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IN-AB1V-01
library(dpclust3p)

sample <- "TCGA-IN-AB1V-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IN-AB1V-01"
