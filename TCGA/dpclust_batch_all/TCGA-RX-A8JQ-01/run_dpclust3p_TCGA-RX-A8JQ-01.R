#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-RX-A8JQ-01
library(dpclust3p)

sample <- "TCGA-RX-A8JQ-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-RX-A8JQ-01"
