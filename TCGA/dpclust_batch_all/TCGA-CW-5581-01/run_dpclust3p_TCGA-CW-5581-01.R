#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-CW-5581-01
library(dpclust3p)

sample <- "TCGA-CW-5581-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-CW-5581-01"
