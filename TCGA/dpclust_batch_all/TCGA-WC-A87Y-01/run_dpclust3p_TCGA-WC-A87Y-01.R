#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-WC-A87Y-01
library(dpclust3p)

sample <- "TCGA-WC-A87Y-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-WC-A87Y-01"
