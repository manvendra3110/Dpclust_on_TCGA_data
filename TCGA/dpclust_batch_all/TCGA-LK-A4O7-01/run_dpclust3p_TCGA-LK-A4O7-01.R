#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-LK-A4O7-01
library(dpclust3p)

sample <- "TCGA-LK-A4O7-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-LK-A4O7-01"
