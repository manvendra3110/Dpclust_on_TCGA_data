#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DK-A1A6-06
library(dpclust3p)

sample <- "TCGA-DK-A1A6-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DK-A1A6-06"
