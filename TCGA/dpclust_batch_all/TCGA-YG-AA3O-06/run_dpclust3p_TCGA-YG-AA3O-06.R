#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-YG-AA3O-06
library(dpclust3p)

sample <- "TCGA-YG-AA3O-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-YG-AA3O-06"
