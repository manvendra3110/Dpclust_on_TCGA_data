#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-QF-A5YS-01
library(dpclust3p)

sample <- "TCGA-QF-A5YS-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-QF-A5YS-01"
