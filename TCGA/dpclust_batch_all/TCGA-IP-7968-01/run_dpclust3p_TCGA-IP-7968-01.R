#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-IP-7968-01
library(dpclust3p)

sample <- "TCGA-IP-7968-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-IP-7968-01"
