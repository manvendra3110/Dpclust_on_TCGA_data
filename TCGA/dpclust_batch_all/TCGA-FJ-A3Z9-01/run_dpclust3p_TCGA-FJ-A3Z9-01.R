#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-FJ-A3Z9-01
library(dpclust3p)

sample <- "TCGA-FJ-A3Z9-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-FJ-A3Z9-01"
