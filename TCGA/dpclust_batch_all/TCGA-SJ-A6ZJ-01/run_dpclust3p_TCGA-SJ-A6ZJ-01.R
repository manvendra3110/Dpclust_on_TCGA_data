#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-SJ-A6ZJ-01
library(dpclust3p)

sample <- "TCGA-SJ-A6ZJ-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-SJ-A6ZJ-01"
