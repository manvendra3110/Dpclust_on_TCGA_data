#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-P5-A5EY-01
library(dpclust3p)

sample <- "TCGA-P5-A5EY-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-P5-A5EY-01"
