#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-QG-A5YX-01
library(dpclust3p)

sample <- "TCGA-QG-A5YX-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-QG-A5YX-01"
