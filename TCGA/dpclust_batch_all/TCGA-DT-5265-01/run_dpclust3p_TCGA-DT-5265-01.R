#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DT-5265-01
library(dpclust3p)

sample <- "TCGA-DT-5265-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DT-5265-01"
