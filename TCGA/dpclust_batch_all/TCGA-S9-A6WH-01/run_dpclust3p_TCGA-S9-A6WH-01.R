#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-S9-A6WH-01
library(dpclust3p)

sample <- "TCGA-S9-A6WH-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-S9-A6WH-01"
