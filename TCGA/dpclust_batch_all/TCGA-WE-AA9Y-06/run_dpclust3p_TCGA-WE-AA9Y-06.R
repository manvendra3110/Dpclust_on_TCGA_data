#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-WE-AA9Y-06
library(dpclust3p)

sample <- "TCGA-WE-AA9Y-06"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-WE-AA9Y-06"
