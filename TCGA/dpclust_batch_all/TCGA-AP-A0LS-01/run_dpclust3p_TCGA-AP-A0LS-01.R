#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-AP-A0LS-01
library(dpclust3p)

sample <- "TCGA-AP-A0LS-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-AP-A0LS-01"
