#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DJ-A1QO-01
library(dpclust3p)

sample <- "TCGA-DJ-A1QO-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DJ-A1QO-01"
