#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-K4-A3WU-01
library(dpclust3p)

sample <- "TCGA-K4-A3WU-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-K4-A3WU-01"
