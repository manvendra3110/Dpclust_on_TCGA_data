#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-BB-7870-01
library(dpclust3p)

sample <- "TCGA-BB-7870-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-BB-7870-01"
