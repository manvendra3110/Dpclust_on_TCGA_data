#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-X9-A971-01
library(dpclust3p)

sample <- "TCGA-X9-A971-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-X9-A971-01"
