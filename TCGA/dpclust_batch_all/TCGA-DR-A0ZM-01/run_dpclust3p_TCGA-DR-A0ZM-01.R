#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-DR-A0ZM-01
library(dpclust3p)

sample <- "TCGA-DR-A0ZM-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-DR-A0ZM-01"
