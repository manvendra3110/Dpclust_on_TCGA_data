#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-EQ-A4SO-01
library(dpclust3p)

sample <- "TCGA-EQ-A4SO-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-EQ-A4SO-01"
