#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-N5-A4RT-01
library(dpclust3p)

sample <- "TCGA-N5-A4RT-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-N5-A4RT-01"
