#!/usr/bin/env Rscript
# Auto-generated R script to run dpclust3p on TCGA-EJ-A46B-01
library(dpclust3p)

sample <- "TCGA-EJ-A46B-01"
output_dir <- "C:/CloneHD_benchmarking/DPclust/TCGA/dpclust_batch_all\TCGA-EJ-A46B-01"
